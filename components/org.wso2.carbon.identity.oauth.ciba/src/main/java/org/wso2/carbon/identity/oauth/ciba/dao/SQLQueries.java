...
public class SQLQueries {
    ...
    public static class CibaSQLQueries {
        ...
        public static final String STORE_CIBA_AUTH_CODE_WITH_RESOLVED_USER = "INSERT INTO IDN_OAUTH2_CIBA_AUTH_CODE " +
                "(AUTH_CODE_KEY, AUTH_REQ_ID, CONSUMER_KEY, ISSUED_TIME, LAST_POLLED_TIME, POLLING_INTERVAL," +
                " EXPIRES_IN, AUTH_REQ_STATUS, RESOLVED_USER_ID, REQUESTED_ACTOR, AUTHORIZATION_DETAILS) " +
                "VALUES (?,?,?,?,?,?,?,?,?,?,?)";
        ...
        public static final String RETRIEVE_AUTHENTICATED_USER_WITH_IDP =
                "SELECT IDN_OAUTH2_CIBA_AUTH_CODE.AUTHENTICATED_USER_NAME, " +
                        "IDN_OAUTH2_CIBA_AUTH_CODE.USER_STORE_DOMAIN, IDN_OAUTH2_CIBA_AUTH_CODE.TENANT_ID, " +
                        "IDP.NAME FROM IDN_OAUTH2_CIBA_AUTH_CODE LEFT JOIN IDP ON " +
                        "IDN_OAUTH2_CIBA_AUTH_CODE.IDP_ID = IDP.ID WHERE AUTH_CODE_KEY = ? ";
        ...
        public static final String UPDATE_AUTHORIZATION_DETAILS =
                "UPDATE IDN_OAUTH2_CIBA_AUTH_CODE SET AUTHORIZATION_DETAILS = ? WHERE AUTH_CODE_KEY = ? ";
        ...
        public static final String RETRIEVE_AUTH_CODE_WITH_IDP_ID = "SELECT AUTH_CODE_KEY, " +
                " AUTH_REQ_ID, CONSUMER_KEY, LAST_POLLED_TIME, POLLING_INTERVAL, EXPIRES_IN, AUTH_REQ_STATUS, " +
                " ISSUED_TIME, IDP_ID, REQUESTED_ACTOR, AUTHORIZATION_DETAILS FROM IDN_OAUTH2_CIBA_AUTH_CODE " +
                "WHERE AUTH_CODE_KEY = ?";
