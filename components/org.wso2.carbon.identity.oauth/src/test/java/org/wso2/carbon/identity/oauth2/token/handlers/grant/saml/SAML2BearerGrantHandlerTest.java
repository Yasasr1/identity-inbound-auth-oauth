...
public class SAML2BearerGrantHandlerTest extends PowerMockIdentityBaseTest {
    ...
    private IdentityProvider getIdentityProvider(String name, String alias, boolean isEnable) {
        ...
        identityProvider.setEnable(isEnable);
    ...
    private IdentityProvider initIdentityProviderManager(String idpName, String alias,
                                                         boolean isIDPEnabled) throws Exception {
