...
//    RETRIEVE_LATEST_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_WITH_IS_SHARED_USER_ORACLE
//            = "SELECT * FROM " +
//            "(SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
...
//    public static final String
//            GET_LATEST_TOKEN_WITH_CONSENTED_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_ORACLE =
//            "SELECT * FROM (SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
//            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD,TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, " +
//            "GRANT_TYPE, CONSENTED_TOKEN, IS_SHARED_USER FROM IDN_OAUTH2_ACCESS_TOKEN " +
//            "WHERE CONSUMER_KEY_ID=(SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ? AND " +
//            "TENANT_ID = ?) AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? AND " +
//            "TOKEN_BINDING_REF = ? AND AUTHORIZED_ORGANIZATION = ? AND IDP_ID=(SELECT ID FROM IDP
//            WHERE NAME =? AND " +
//            "TENANT_ID=?) ORDER BY TIME_CREATED DESC) WHERE ROWNUM < 2 ";
...
//    public static final String
//    RETRIEVE_LATEST_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_WITH_IS_SHARED_USER_MYSQL =
//            "SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
//            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE, " +
//            "IS_SHARED_USER FROM " +
//            "IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
...
//    public static final String
//            GET_LATEST_TOKEN_WITH_CONSENTED_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_MYSQL =
//            "SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
//            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE, " +
//            "CONSENTED_TOKEN, IS_SHARED_USER FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = (SELECT ID FROM " +
//            "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ? AND TENANT_ID = ?) AND AUTHZ_USER=? AND
//            TENANT_ID=? AND " +
//            "USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? AND TOKEN_BINDING_REF = ? AND AUTHORIZED_ORGANIZATION = ? " +
//            "AND IDP_ID=(SELECT ID FROM IDP WHERE NAME =? AND TENANT_ID=?) ORDER BY TIME_CREATED DESC LIMIT 1";
...
//    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_DB2SQL =
//            "SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
//            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE, " +
//            "IS_SHARED_USER FROM " +
//            "IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID= (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
...
//    public static final String
//            GET_LATEST_TOKEN_WITH_CONSENTED_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_DB2SQL =
//            "SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
//            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE, " +
//            "CONSENTED_TOKEN, IS_SHARED_USER FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID= (SELECT ID FROM " +
//            "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ? AND TENANT_ID = ?) AND AUTHZ_USER=? AND
...
//    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_MSSQL =
//            "SELECT TOP 1 ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
//            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE, " +
//            "IS_SHARED_USER FROM " +
//            "IDN_OAUTH2_ACCESS_TOKEN WITH (NOLOCK) WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS " +
...
//    public static final String
//            GET_LATEST_TOKEN_WITH_CONSENTED_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_MSSQL =
//            "SELECT TOP 1 ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
//            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE, " +
//            "CONSENTED_TOKEN, IS_SHARED_USER FROM IDN_OAUTH2_ACCESS_TOKEN WITH (NOLOCK) WHERE CONSUMER_KEY_ID = " +
//            "(SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ? AND TENANT_ID = ?) AND
//            AUTHZ_USER=? AND " +
//            "TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? AND TOKEN_BINDING_REF = ? AND " +
//            "AUTHORIZED_ORGANIZATION = ? AND IDP_ID=(SELECT ID FROM IDP WHERE NAME =? AND TENANT_ID=?) ORDER BY " +
//            "TIME_CREATED DESC";
...
//    public static final String
//            RETRIEVE_LATEST_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_POSTGRESQL = "SELECT * " +
//            "FROM (SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
//            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE, " +
//            "IS_SHARED_USER FROM " +
//            "IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
//            "CONSUMER_KEY = ? AND TENANT_ID = ?) AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND " +
//            "TOKEN_SCOPE_HASH=? AND TOKEN_BINDING_REF = ? AND AUTHORIZED_ORGANIZATION = ? " +
//            "AND IDP_ID=(SELECT ID FROM IDP WHERE NAME =? AND TENANT_ID=?) ORDER BY
...
//    public static final String
//            GET_LATEST_TOKEN_WITH_CONSENTED_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_PGSQL =
//            "SELECT * FROM (SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
//            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, " +
//            "GRANT_TYPE, CONSENTED_TOKEN, IS_SHARED_USER FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = " +
...
//            "TOKEN_BINDING_REF = ? AND AUTHORIZED_ORGANIZATION = ? AND IDP_ID=(SELECT ID FROM IDP
//            WHERE NAME =? AND " +
//            "TENANT_ID=?) ORDER BY TIME_CREATED DESC) TOKEN LIMIT 1 ";
...
//    public static final String
//            RETRIEVE_LATEST_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_INFORMIX = "SELECT " +
//            "FIRST 1 * FROM" +
//            " (SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
//            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE, " +
//            "IS_SHARED_USER FROM " +
...
//    public static final String
//            GET_LATEST_TOKEN_WITH_CONSENTED_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_INFMIX =
//            "SELECT FIRST 1 * FROM (SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
//            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, " +
//            "GRANT_TYPE, CONSENTED_TOKEN, IS_SHARED_USER FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = " +
//            "(SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ? AND TENANT_ID = ?) AND AUTHZ_USER=? " +
//            "AND TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? AND TOKEN_BINDING_REF = ? AND " +
//            "AUTHORIZED_ORGANIZATION = ? AND IDP_ID=(SELECT ID FROM IDP WHERE NAME =? AND TENANT_ID=?) ORDER BY " +
//            "TIME_CREATED DESC) TOKEN ";
    ...
    public static final String RETRIEVE_ACTIVE_ACCESS_TOKEN_IDP_NAME_WITH_IS_SHARED_USER =
            "SELECT CONSUMER_KEY, AUTHZ_USER, ACCESS_TOKEN_TABLE.TENANT_ID, " +
                    "USER_DOMAIN, TOKEN_SCOPE, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
                    "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, REFRESH_TOKEN, ACCESS_TOKEN_TABLE.TOKEN_ID, " +
                    "GRANT_TYPE, SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, " +
                    "AUTHORIZED_ORGANIZATION, ACCESS_TOKEN_TABLE.APP_TENANT_ID, IDP.NAME, IS_SHARED_USER " +
                    "FROM (SELECT TOKEN_ID, CONSUMER_KEY," +
                    "  AUTHZ_USER, IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID AS TENANT_ID, " +
                    "IDN_OAUTH2_ACCESS_TOKEN.USER_DOMAIN AS USER_DOMAIN,TIME_CREATED," +
                    "REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, " +
                    ...
                    "SUBJECT_IDENTIFIER, IDN_OAUTH2_ACCESS_TOKEN.IDP_ID AS IDP_ID, " +
                    "TOKEN_BINDING_REF, AUTHORIZED_ORGANIZATION, IDN_OAUTH_CONSUMER_APPS.TENANT_ID AS APP_TENANT_ID, " +
                    "IS_SHARED_USER FROM (SELECT * FROM IDN_OAUTH2_ACCESS_TOKEN WHERE ACCESS_TOKEN_HASH=? AND " +
                    "TOKEN_STATE='ACTIVE') IDN_OAUTH2_ACCESS_TOKEN " +
                    "JOIN IDN_OAUTH_CONSUMER_APPS ON CONSUMER_KEY_ID = ID) ACCESS_TOKEN_TABLE" +
                    " LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE ON ACCESS_TOKEN_TABLE.TOKEN_ID = " +
                    "IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID JOIN IDP ON IDP_ID = IDP.ID";
    ...
    public static final String RETRIEVE_ACTIVE_ACCESS_TOKEN_IDP_NAME_WITH_CONSENTED_TOKEN_WITH_IS_SHARED_USER =
            "SELECT CONSUMER_KEY, AUTHZ_USER, ACCESS_TOKEN_TABLE.TENANT_ID, " +
                    "USER_DOMAIN, TOKEN_SCOPE, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
                    "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, REFRESH_TOKEN, ACCESS_TOKEN_TABLE.TOKEN_ID, " +
                    "GRANT_TYPE, SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, AUTHORIZED_ORGANIZATION, " +
                    "ACCESS_TOKEN_TABLE.APP_TENANT_ID, IDP.NAME, CONSENTED_TOKEN, IS_SHARED_USER FROM " +
                    "(SELECT TOKEN_ID, CONSUMER_KEY,  AUTHZ_USER, IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID AS TENANT_ID, " +
                    "IDN_OAUTH2_ACCESS_TOKEN.USER_DOMAIN AS USER_DOMAIN,TIME_CREATED," +
                    "REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, " +
                    "REFRESH_TOKEN, IDN_OAUTH2_ACCESS_TOKEN.GRANT_TYPE AS GRANT_TYPE," +
                    "SUBJECT_IDENTIFIER, IDN_OAUTH2_ACCESS_TOKEN.IDP_ID AS IDP_ID, " +
                    "TOKEN_BINDING_REF, AUTHORIZED_ORGANIZATION, IDN_OAUTH_CONSUMER_APPS.TENANT_ID AS APP_TENANT_ID, " +
                    "CONSENTED_TOKEN, IS_SHARED_USER FROM (SELECT * FROM IDN_OAUTH2_ACCESS_TOKEN WHERE " +
                    "ACCESS_TOKEN_HASH=? AND TOKEN_STATE='ACTIVE') IDN_OAUTH2_ACCESS_TOKEN " +
                    "JOIN IDN_OAUTH_CONSUMER_APPS ON CONSUMER_KEY_ID = ID) ACCESS_TOKEN_TABLE" +
                    " LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE ON ACCESS_TOKEN_TABLE.TOKEN_ID = " +
                    "IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID JOIN IDP ON IDP_ID = IDP.ID";
    ...
    public static final String RETRIEVE_ACTIVE_EXPIRED_ACCESS_TOKEN_IDP_NAME_WITH_IS_SHARED_USER =
            ...
            "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, REFRESH_TOKEN, IDN_OAUTH2_ACCESS_TOKEN.GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, IDN_OAUTH2_ACCESS_TOKEN.IDP_ID, TOKEN_BINDING_REF, " +
            "AUTHORIZED_ORGANIZATION, IDN_OAUTH_CONSUMER_APPS.TENANT_ID AS APP_TENANT_ID, IS_SHARED_USER " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN JOIN IDN_OAUTH_CONSUMER_APPS ON CONSUMER_KEY_ID = ID " +
            "WHERE ACCESS_TOKEN_HASH=? AND (TOKEN_STATE='ACTIVE' OR TOKEN_STATE='EXPIRED')) ACCESS_TOKEN_TABLE LEFT " +
            "JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE " +
            "ON ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID " +
    ...
    public static final String INSERT_OAUTH2_ACCESS_TOKEN_WITH_IDP_NAME_WITH_CONSENTED_TOKEN_WITH_IS_SHARED_USER =
            "INSERT INTO IDN_OAUTH2_ACCESS_TOKEN (ACCESS_TOKEN, REFRESH_TOKEN, CONSUMER_KEY_ID, AUTHZ_USER, " +
            "TENANT_ID, USER_DOMAIN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_SCOPE_HASH, TOKEN_STATE, USER_TYPE, TOKEN_ID, GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, ACCESS_TOKEN_HASH, REFRESH_TOKEN_HASH, IDP_ID, TOKEN_BINDING_REF, " +
            "AUTHORIZED_ORGANIZATION, " +
            "CONSENTED_TOKEN, IS_SHARED_USER) SELECT ?,?,IDN_OAUTH_CONSUMER_APPS.ID,?,?,?,?,?,?,?,?,?,?,?,?,?," +
            "?,?,IDP.ID,?,?,?,? FROM " +
            "IDN_OAUTH_CONSUMER_APPS, IDP WHERE IDP.NAME=? AND IDP.TENANT_ID=? AND CONSUMER_KEY=? AND " +
            "IDN_OAUTH_CONSUMER_APPS.TENANT_ID=?";
...
//    public static final String
//            RETRIEVE_LATEST_ACTIVE_ACCESS_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_MYSQL = "SELECT " +
//            "ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
//            "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, IS_SHARED_USER FROM " +
//            "IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID =(SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
//            "CONSUMER_KEY = ? AND TENANT_ID = ?) AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND " +
//            "TOKEN_SCOPE_HASH=? AND AUTHORIZED_ORGANIZATION = ? AND TOKEN_STATE='ACTIVE' AND
//            IDP_ID=(SELECT ID FROM " +
//            "IDP WHERE NAME=? AND TENANT_ID=?) ORDER BY TIME_CREATED DESC LIMIT 1";
...
//    public static final String
//            RETRIEVE_LATEST_ACTIVE_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_ORACLE =
//            "SELECT * FROM (SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
...
//            "TOKEN_SCOPE_HASH=? AND AUTHORIZED_ORGANIZATION = ? AND TOKEN_STATE='ACTIVE' AND
//            IDP_ID=(SELECT ID FROM " +
//            "IDP WHERE NAME=? AND TENANT_ID=?) ORDER BY TIME_CREATED DESC) WHERE ROWNUM < 2 ";
...
//    public static final String
//            RETRIEVE_LATEST_ACTIVE_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_DB2SQL =
//            "SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
//            "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, IS_SHARED_USER FROM " +
//            "IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
//            "CONSUMER_KEY = ? AND TENANT_ID = ?) AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND " +
//            "TOKEN_SCOPE_HASH=? AND AUTHORIZED_ORGANIZATION = ? AND TOKEN_STATE='ACTIVE' AND
//            IDP_ID=(SELECT ID FROM " +
//            "IDP WHERE NAME=? AND TENANT_ID=?) ORDER BY TIME_CREATED DESC FETCH FIRST 1 ROWS ONLY";
...
//    public static final String
//            RETRIEVE_LATEST_ACTIVE_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_MSSQL =
//            "SELECT TOP 1 ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
//            "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, IS_SHARED_USER FROM " +
//            "IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
//            "CONSUMER_KEY = ? AND TENANT_ID = ?) AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND " +
//            "TOKEN_SCOPE_HASH=? AND AUTHORIZED_ORGANIZATION = ? AND TOKEN_STATE='ACTIVE' AND
//            IDP_ID=(SELECT ID FROM " +
//            "IDP WHERE NAME=? AND TENANT_ID=?) ORDER BY TIME_CREATED DESC";
...
//    public static final String
//            RETRIEVE_LATEST_ACTIVE_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_POSTGRESQL =
//            "SELECT * FROM (SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
//            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER,
//            IS_SHARED_USER " +
//            "FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
...
//    public static final String
//    RETRIEVE_LATEST_ACTIVE_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_INFORMIX =
//            "SELECT FIRST 1 * FROM (SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
//            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, " +
//            "IS_SHARED_USER FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = " +
//            "(SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ? AND TENANT_ID = ?) AND
//            AUTHZ_USER=? AND " +
//            "TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? AND AUTHORIZED_ORGANIZATION = ? " +
//            "AND TOKEN_STATE='ACTIVE' AND IDP_ID=(SELECT ID FROM IDP WHERE NAME=? AND " +
//            "TENANT_ID=?) ORDER BY TIME_CREATED DESC) TOKEN ";
...
//    public static final String
//            RETRIEVE_LATEST_NON_ACTIVE_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_MYSQL =
//            "SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
//            "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, IS_SHARED_USER " +
//            "FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID =(SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
//            "CONSUMER_KEY = ? AND TENANT_ID = ?) AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND " +
//            "TOKEN_SCOPE_HASH=? AND AUTHORIZED_ORGANIZATION = ? AND TOKEN_STATE!='ACTIVE' AND " +
//            "IDP_ID=(SELECT ID FROM IDP WHERE NAME=? AND TENANT_ID=?) ORDER BY TIME_CREATED DESC LIMIT 1";
...
//    public static final String
//            RETRIEVE_LATEST_NON_ACTIVE_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_ORACLE =
//            "SELECT * FROM (SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
//            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, " +
//            "IS_SHARED_USER FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID=(SELECT ID FROM " +
//            "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ? AND TENANT_ID = ?) AND AUTHZ_USER=? AND TENANT_ID=?
//            AND " +
//            "USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? AND AUTHORIZED_ORGANIZATION = ? AND TOKEN_STATE!='ACTIVE' AND " +
//            "IDP_ID=(SELECT ID FROM IDP WHERE NAME=? AND TENANT_ID=?) ORDER BY TIME_CREATED DESC) WHERE ROWNUM < 2 ";
...
//    public static final String
//            RETRIEVE_LATEST_NON_ACTIVE_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_DB2SQL =
//            "SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
//            "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, IS_SHARED_USER FROM " +
//            "IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID= (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
//            "CONSUMER_KEY = ? AND TENANT_ID = ?) AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND " +
...
//    public static final String
//            RETRIEVE_LATEST_NON_ACTIVE_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_MSSQL =
//            "SELECT TOP 1 ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
//            "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, IS_SHARED_USER FROM " +
//            "IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
//            "CONSUMER_KEY = ? AND TENANT_ID = ?) AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND " +
//            "TOKEN_SCOPE_HASH=? AND AUTHORIZED_ORGANIZATION = ? AND TOKEN_STATE!='ACTIVE'
//            AND IDP_ID=(SELECT ID FROM " +
//            "IDP WHERE NAME=? AND TENANT_ID=?) ORDER BY TIME_CREATED DESC";
...
//    public static final String
//            RETRIEVE_LATEST_INACTIVE_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_POSTGRESQL =
//            "SELECT * FROM (SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
//            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, " +
//            "IS_SHARED_USER FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = (SELECT ID FROM " +
//            "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ? AND TENANT_ID = ?) AND AUTHZ_USER=? " +
//            "AND TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? AND AUTHORIZED_ORGANIZATION = ? AND " +
//            "TOKEN_STATE!='ACTIVE' AND IDP_ID=(SELECT ID FROM IDP WHERE NAME=? AND TENANT_ID=?) " +
//            "ORDER BY TIME_CREATED DESC) TOKEN LIMIT 1 ";
...
//    public static final String
//            RETRIEVE_LATEST_NON_ACTIVE_TOKEN_WITH_SHARED_USER_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_INFORMIX =
//            "SELECT FIRST 1 * FROM (SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
//            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER,
//            IS_SHARED_USER " +
//            "FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
...
//            "TENANT_ID=?) ORDER BY TIME_CREATED DESC) TOKEN ";
    ...
    public static final String GET_ACCESS_TOKEN_EXTENDED_ATTRIBUTES =
            "SELECT TOKEN_ATTR_NAME, TOKEN_ATTR_VALUE FROM IDN_OAUTH2_ACCESS_TOKEN_ATTRIBUTES WHERE TOKEN_ID = ?";
