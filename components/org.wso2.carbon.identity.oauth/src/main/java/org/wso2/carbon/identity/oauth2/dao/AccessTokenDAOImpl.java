...
//                user.setSharedUser(isSharedUser);
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                if (iterateId == 0) {
                    ...
                    String authenticatedIDP = resultSet.getString(18);
    ...
    private Map<String, String> getAccessTokenExtendedAttributeParameters(String accessTokenIdentifier)
        ...
        try (Connection connection = IdentityDatabaseUtil.getDBConnection(false);
            ...
            try (ResultSet resultSet = prepStmt.executeQuery()) {
                while (resultSet.next()) {
                    String key = resultSet.getString("TOKEN_ATTR_NAME");
                    String value = resultSet.getString("TOKEN_ATTR_VALUE");
                    parameters.put(key, value);
                }
            }
            return parameters;
        } catch (SQLException e) {
            throw new IdentityOAuth2Exception("Error occurred while retrieving extended attributes for access token: " +
    ...
    private Set<AccessTokenDO> getAccessTokensByTenant(int tenantId, String userStoreDomain)
        ...
        Map<String, AccessTokenDO> accessTokenDOMap = new HashMap<>();
        try {
            String sql = SQLQueries.LIST_ALL_TOKENS_IN_TENANT_IDP_NAME;
            ...
            while (resultSet.next()) {
                ...
                if (accessTokenDOMap.get(accessToken) == null) {
                    ...
                    String authenticatedIDP = resultSet.getString(14);
    ...
    private Set<AccessTokenDO> getAccessTokensByAuthorizedOrg(String organizationId, String userStoreDomain)
        ...
        String sql = SQLQueries.LIST_ALL_TOKENS_ISSUED_FOR_ORGANIZATION_IDP_NAME;
    ...
    public Set<AccessTokenDO> getAccessTokensOfUserStore(int tenantId, String userStoreDomain) throws
        ...
        Map<String, AccessTokenDO> accessTokenDOMap = new HashMap<>();
        try {
            String sql = SQLQueries.LIST_ALL_TOKENS_IN_USER_STORE_IDP_NAME;
            ...
            while (resultSet.next()) {
                ...
                if (accessTokenDOMap.get(accessToken) == null) {
                    ...
                    String authenticatedIDP = resultSet.getString(12);
    ...
    private void recoverFromConAppKeyConstraintViolation(String accessToken, String consumerKey, AccessTokenDO
        ...
        try {
            ...
            log.warn("'CON_APP_KEY' constrain violation retry attempt for application with " +
