...
public class JWTTokenIssuer extends OauthTokenIssuerImpl {
    ...
    protected JWTClaimsSet createJWTClaimSet(OAuthAuthzReqMessageContext authAuthzReqMessageContext,
        ...
        jwtClaimsSetBuilder.expirationTime(calculateTokenExpiryTime(accessTokenLifeTimeInMillis,
                curTimeInMillis));
    ...
    private JWTClaimsSet createRefreshTokenJWTClaimSet(OAuthAuthzReqMessageContext authAuthzReqMessageContext,
        ...
        jwtClaimsSetBuilder.expirationTime(calculateTokenExpiryTime(refreshTokenLifeTimeInMillis,
                issuedTimeInMillis));
