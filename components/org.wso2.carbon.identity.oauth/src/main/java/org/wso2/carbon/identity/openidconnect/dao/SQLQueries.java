...
public class SQLQueries {
    ...
    public static final String STORE_IDN_OIDC_REQ_OBJECT_CLAIMS_H2 = "INSERT INTO IDN_OIDC_REQ_OBJECT_CLAIMS " +
            "(REQ_OBJECT_ID,CLAIM_ATTRIBUTE, ESSENTIAL, `VALUE`, IS_USERINFO) VALUES (?, ?, ?, ?, ?)";
    ...
    public static final String UPDATE_REQUEST_OBJECT_TOKEN_BY_CODE = "UPDATE IDN_OIDC_REQ_OBJECT_REFERENCE SET " +
            "TOKEN_ID=?, CODE_ID=? WHERE CODE_ID=?";
    ...
    public static final String RETRIEVE_REQUESTED_CLAIMS_BY_TOKEN_H2 = "SELECT CLAIM_ATTRIBUTE, ESSENTIAL, `VALUE` " +
            " FROM IDN_OIDC_REQ_OBJECT_CLAIMS" +
            " LEFT JOIN IDN_OIDC_REQ_OBJECT_REFERENCE" +
            " ON IDN_OIDC_REQ_OBJECT_CLAIMS.REQ_OBJECT_ID = IDN_OIDC_REQ_OBJECT_REFERENCE.ID" +
            " WHERE TOKEN_ID=? AND IS_USERINFO=? ";
    ...
    public static final String RETRIEVE_REQUESTED_CLAIMS_BY_SESSION_DATA_KEY_H2 = "SELECT CLAIM_ATTRIBUTE, ESSENTIAL," +
            " `VALUE` FROM IDN_OIDC_REQ_OBJECT_CLAIMS" +
            " LEFT JOIN IDN_OIDC_REQ_OBJECT_REFERENCE" +
            " ON IDN_OIDC_REQ_OBJECT_CLAIMS.REQ_OBJECT_ID = IDN_OIDC_REQ_OBJECT_REFERENCE.ID" +
            " WHERE SESSION_DATA_KEY=? AND IS_USERINFO=?";
